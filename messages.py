...
class Messages:
    ...
    def __init__(self):
        ...
        self.start_polling = '🔔 Тестовый бот запущен' if config.DEBUG_MODE else '🔔 Основной бот запущен'
        self.stop_polling = '🔔 Тестовый бот остановлен' if config.DEBUG_MODE else '🔔 Основной бот остановлен'
